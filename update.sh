...
# Remove untracked build artefacts so git pull is never blocked by dist/ files
# that were generated by a previous build but are absent from .gitignore.
sudo -u "${APP_USER}" git -C "${INSTALL_DIR}" clean -fd \
  artifacts/api-server/dist/ \
  artifacts/aio-voice-connect-manager/dist/ \
